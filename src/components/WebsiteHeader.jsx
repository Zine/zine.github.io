        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div className="flex-1 flex flex-col items-center gap-4 whitespace-nowrap">
                        <div className="flex flex-col items-center justify-center gap-4 w-full truncate">
                            <a className="max-w-full overflow-hidden grid" target="_self" href="/">
                                <h1
